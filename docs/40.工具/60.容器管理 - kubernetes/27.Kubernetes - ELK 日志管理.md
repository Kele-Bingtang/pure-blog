...
Logstash 得到日志后，内部可以进行数据的清晰等操作，然后发给 ElasticSearch，接着 Kibana 通过 ElasticSearch 的 API 去 ElasticSearch 里检索日志，在页面展示给程序员、运维人员看。

Kibana 是一个 ElasticSearch 的可视化界面

如下图：

![image-20230624151651646](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Spring%20Boot/20230624151652.png)

## 集成 ELK

![image-20230624151623028](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Spring%20Boot/20230624151631.png)
