...
![image-20220303174143608](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093436.png)

【窗口】->【显示视图】->【其他】，打开 MDP 透视图。

对刚刚创建的 UAP 业务组件项目右键：新建实体组件，接着创建一个「实体」，并右键实体，找到特性，分别选择「组织信息、审计信息、富客户端单据信息」。

![image-20220303174445002](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093440.png)

- 左键点击实体，在右边的「访问器类型」选择 `AggVO`，修改名称、显示名称，主属性选择 id

    ![image-20220303174842484](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093442.png)

- 左键点击空白处，在右边的「代码风格」选择自定义样式

    ![image-20220303174854805](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093445.png)
...
![image-20220303215058224](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093448.png)

### 功能注册

![image-20220303215012270](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093450.png)

### 菜单注册

![image-20220303215136734](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093455.png)

### 菜单授权

【动态建模平台】->【权限管理】->【职责-集团】，进入权限管理。

![image-20220303215526682](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093457.png)

首先点击查询，然后确定，就会查出很多的数据，点击末页，找到 `yongyou_qq`，打开。

![image-20220303215718665](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093458.png)

然后把自己的菜单添加到右边。

![image-20220303215747167](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093500.png)

### 单据模板初始化

搜索发布的实体，添加。

![image-20220303215935610](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093502.png)

### 查询模板初始化

查询自己的模板编码。

![image-20220303220021334](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093559.png)

进入修改界面，添加数据。

![image-20220303220044754](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093504.png)

输入模板的信息，并且将数据库的字段拖到右边。

![image-20220303220142874](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093505.png)

### 功能节点默认模板输出

所属银行和国家地区不需要填写。

![image-20220303220315335](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093507.png)
...
![image-20220304091602190](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093509.png)
...
![image-20220304093217076](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/yonyou/20220304093517.png)
