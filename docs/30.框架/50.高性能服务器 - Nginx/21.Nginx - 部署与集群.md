...
![1604498725652](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211130172629.png)
...
- 启动完成 Tomcat 后，进行访问测试
    ...
    - 静态资源：`http://192.168.200.146:8080/demo/index.html`
        ...
        ![image-20211129123837835](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129123846.png)

    - 动态资源：`http://192.168.200.146:8080/demo/getAddress`

        动态资源可以是端口号，此时的端口是 8080

        ![image-20211129124753971](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129124819.png)
...
![1604421312486](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129124916.png)
...
![1604422564855](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129150518.png)
...
- 在 Nginx 所在的服务器 B 上创建如下目录，并将对应的静态资源放入指定的位置
    ...
    ![1604493947499](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129151615.png)
...
- 启动测试，访问 `http://192.168.200.133`
    ...
    ![1604494128097](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129150848.png)

    假如某个时间点，由于某个原因导致 Tomcat 后的服务器宕机了，我们再次访问 Nginx，会得到如下效果：

    ![1604494156197](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129152116.png)
...
![1604494256017](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129152253.png)
...
![1604494269848](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129152549.png)
...
![image-20211129153012231](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129153013.png)
...
![1604494822961](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129153044.png)

```http
http://192.168.200.146:8180/demo/getAddress
```

![1604494843886](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129153046.png)

```http
http://192.168.200.146:8280/demo/getAddress
```

![1604494860954](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129153048.png)
...
![1604495169905](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129153455.png)
...
![1604495824757](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129153516.png)
...
![1604495442179](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129153526.png)
...
- `/etc/keepalived/keepalived.conf`：keepalived 的系统配置文件，我们主要操作的就是该文件
    ...
    ![image-20211129155635556](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129155700.png)

- `/usr/local/sbin` 目录下的 `keepalived`：这是系统配置脚本，用来启动和关闭 keepalived

    ![image-20211129155656699](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129155657.png)
...
![1604599529242](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129162240.png)
...
![1604599616821](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129162308.png)
...
![1604599709822](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129162648.png)
...
![1604600079149](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129163014.png)
...
![1604600145318](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129163225.png)
...
- 编写脚本，这里的脚本名是 `ck_nginx.sh`，位置在 `/etc/keepalived` 路径下
    ...
    ![image-20211129164825064](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Nginx/20211129164825.png)
