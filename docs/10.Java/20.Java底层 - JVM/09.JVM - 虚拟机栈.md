...
![image-20200705163928652](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000812.png)
...
![image-20200705164722033](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000814.png)
...
![image-20200705165025382](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000816.png)
...
![image-20220117182844415](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220117182845.png)
...
![image-20200705203142545](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000818.png)
...
![image-20200705203916023](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116001224.png)
...
![image-20220118223319239](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220118223320.png)

并行每个线程下的栈都是私有的，因此每个线程都有自己各自的栈，并且每个栈里面都有很多栈帧，栈帧的大小主要由局部变量表和操作数栈决定的

![image-20200705205443993](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000825.png)
...
![image-20220117233913735](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220117233914.png)
...
![image-20220117234123280](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220117234124.png)

2. 方法异常信息表

![image-20220117234212112](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220117234213.png)

3. Misc

![image-20220117234353704](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220117234354.png)

4. 行号表

Java 代码的行号和字节码指令行号的对应关系

![image-20220117235010443](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220117235011.png)

注意：生效行数和剩余有效行数都是针对于字节码文件的行数

![image-20220117235108944](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220117235110.png)
...
![image-20200705212454445](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000827.png)
...
![image-20220118000401578](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220118000402.png)
...
![image-20220118000532784](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220118000533.png)
...
![image-20220118000728976](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220118000730.png)
...
![image-20200706090618332](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000831.png)

代码举例

![image-20200706090833697](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220118144126.png)
...
![image-20200706092610730](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000834.png)

![image-20220118150416259](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220118150417.png)
...
![image-20200706093131621](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000951.png)

执行完后，让 PC + 1，指向下一行代码，下一行代码就是将操作数栈的元素存储到局部变量表 1 的位置（istore_1），我们可以看到局部变量表的已经增加了一个元素，然后操作数栈为空了。

![image-20200706093251302](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000837.png)
...
![image-20200706093646406](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000839.png)

![image-20200706093751711](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000840.png)

然后从局部变量表中，依次将数据放在操作数栈中，等待执行 add 操作

iload_1：取出局部变量表中索引为 1 的数据入操作数栈

![image-20200706093859191](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000842.png)

![image-20200706093921573](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000848.png)

然后将操作数栈中的两个元素执行相加操作，并存储在局部变量表 3 的位置

![image-20200706094046782](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000852.png)

![image-20200706094109629](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000854.png)

最后 PC 寄存器的位置指向 10，也就是 return 方法，则直接退出方法。

### 类型转换说明

![image-20220118150932881](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220118150934.png)
...
![image-20220118151053312](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220118151054.png)
...
![image-20200706100311886](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000858.png)
...
![image-20200706101251847](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000859.png)
...
![image-20220118163027451](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220118163028.png)
...
![image-20220118163859467](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220118163900.png)
...
![image-20200706144954070](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000903.png)
...
![image-20200706154554604](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220116000904.png)
...
![image-20220118221029415](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220118221030.png)
