...
![image-20200705080719531](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220115234152.png)

完整图如下：

![image-20200705080911284](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220115234155.png)
...
![image-20200705081813409](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220115234158.png)
...
![image-20200705081913538](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220115234206.png)
...
![image-20200705082255746](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220115234209.png)

`.class` 文件先经过装载，如果文件不合法或被恶意修改，则抛出异常，否则就链接，初始化、调用 `main()` 方法，输出结果。

完整的流程图如下所示：

![image-20200705082601441](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220115234213.png)
...
![image-20220117130152728](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220117130153.png)
...
![image-20200705084038680](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220115234217.png)

如果出现不合法的字节码文件，那么将会验证不通过。

同时我们可以通过安装 IDEA 的插件 `jclass`，来查看我们的 Class 文件。

![image-20220117132705913](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220117132707.png)

安装完成后，我们编译完一个 Class 文件后，点击 view 即可显示我们安装的插件来查看字节码方法了。

![image-20220117132800037](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220117132800.png)
...
![image-20220117132839878](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220117132840.png)
...
![image-20200705094149223](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220115234338.png)
...
![image-20200705103516138](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220115234341.png)

`sun.misc.Launcher` 是一个 Java 虚拟机的入口应用

![image-20200705103636003](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220115234343.png)
...
![image-20200705105151258](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220115234355.png)
...
![image-20220117144053988](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220117144055.png)
...
![image-20200705105810107](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220115234347.png)
