...
![image-20220131152127843](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131152135.png)
...
![image-20220131153051380](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131153052.png)
...
![image-20220131153248445](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131153249.png)
...
![image-20220131153629853](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131153630.png)
...
![image-20220131153919947](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131153920.png)

> **jstat -compiler**

显示 JIT 编译器编译过的方法、耗时等信息。

![image-20220131154943898](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131154944.png)

> **jstat -printcompilation**

输出已经被 JIT 编译的方法。

![image-20220131155122971](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131155123.png)
...
![image-20220131160826978](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131160828.png)
...
![image-20220131160931520](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131160932.png)

> **jstat -gcutil**

显示内容与 `-gc` 基本相同，但输出主要关注已使用空间占总空间的百分比。

![image-20220131161054138](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131161055.png)
...
![image-20220131161322060](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131161323.png)

> **jstat -gcnew**

显示新生代 GC 状况。

![image-20220131161525208](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131161526.png)

> **jstat -gcnewcapacity**

显示内容与 `-gcnew` 基本相同，输出主要关注使用到的最大、最小空间。

![image-20220131161618811](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131161622.png)

> **jstat -gcold**

显示老年代 GC 状况。

![image-20220131161659710](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131161700.png)

> **jstat -gcoldcapacity**

显示内容与 `-gcold` 基本相同，输出主要关注使用到的最大、最小空间。

![image-20220131161741659](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131161743.png)
...
![image-20220131154811037](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131154811.png)

> **jstat -t**

可以在输出信息前加上一个 Timestamp 列，显示程序的运行时间。单位：秒。

![image-20220131161938786](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131161939.png)

> **jstat -t -h**

可以在周期性数据输出时，输出多少行数据后输出一个表头信息。

![image-20220131162141993](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131162142.png)
...
![image-20220131172515141](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131173513.png)

在 D 盘生成了 4 个文件，其中 4.hprof 用了第二个命令生成。

![image-20220131173748601](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131173749.png)
...
![image-20220131173702078](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131173703.png)
...
![image-20220131211705430](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131211706.png)
...
![image-20220131212831537](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131212832.png)

打开浏览器访问 `http://localhost:7000/`。

![image-20220131212920407](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131212921.png)
...
![image-20220131215206187](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131220402.png)
...
![image-20220131220953560](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131220954.png)

> 常用命令

**jcmd -l**：列出所有的 JVM 进程，可以替换 `jps -m`。如图：

![image-20220131220313703](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131220314.png)

**jcmd 进程号 help**：针对指定的进程，列出支持的所有具体命令，如图：

![image-20220131220228871](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131220229.png)
...
![image-20220131221034831](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Java/20220131221035.png)
